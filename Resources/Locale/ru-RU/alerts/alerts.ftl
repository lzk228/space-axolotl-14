...
alerts-knockdown-name = [color=yellow]Упал[/color]
alerts-knockdown-desc = Вы [color=yellow]упали[/color]! Что-то вас подскользнуло или толкнуло Something has slipped or pushed you over, помешав вашему движению.
