...
ent-EngineeringBorgChassisDerelict = заброшенный киборг-инженер
    .desc = Гибрид человека и машины, помогающий инженерному отделу. На поверхности этого, похоже, куски странных кристаллов.
ent-JanitorBorgChassisDerelict = заброшенный киборг-уборщик
    .desc = Гибрид человека и машины, помогающий сервисному отделу. Он больший бардак, чем всё, что он может убрать.
