...
ent-MobBaseKobold = кобольд
    .desc = Двоюродные братья разумной расы рептилий, кобольды сливаются со своей естественной средой обитания, и так же противны, как обезьяны. Они готовы вырвать ваши волосы и заколоть вас до смерти.
