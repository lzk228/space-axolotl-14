...
ent-MobBaseKobold = кобольд
    .desc = Двоюродные братья разумного вида рептилий, кобольды сливаются со своей естественной средой обитания и также противны, как обезьяны. Они готовы вырвать ваши волосы и заколоть вас до смерти.
