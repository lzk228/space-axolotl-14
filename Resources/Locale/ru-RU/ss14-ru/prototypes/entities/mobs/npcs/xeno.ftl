...
ent-MobSmallPurpleSnake = космическая гадюка
    ...
    .suffix = Маленькая
ent-MobXenoLonePraetorianNoGhost = "Дэйл"
    .desc = Преторианец, оставшийся после первоначальной зачистки станции. У него в пасти застряла пара окровавленных жетонов с выгравированным именем "Рядовой Дэйл".
