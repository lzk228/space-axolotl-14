...
ent-HoloprojectorClownBorg = проектор голокожурки
    .desc = Проектор голокожурки, который создаёт скользкую банановую кожурку из твёрдого света. Перезаряжается автоматически, чтобы веселье никогда не заканчивалось!
    .suffix = Борг
