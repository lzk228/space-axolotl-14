...
ent-PowerCellHyper = батарея гипер ёмкости
    .desc = Стандартизированный перезаряжаемый элемент питания. Эта версия расширяет верхние пределы портативных накопителей энергии, обладая на 66% большей ёмкостью, чем её предшественница.
    .suffix = Полный
