...
ent-BaseImplantOnlyImplanterSyndi = имплантер Синдиката
    .desc = Компактный одноразовый шприц, специально предназначенный для введения подкожных имплантов. Обязательно почистите его мылом или тряпкой после использования, чтобы удалить остатки ДНК.
