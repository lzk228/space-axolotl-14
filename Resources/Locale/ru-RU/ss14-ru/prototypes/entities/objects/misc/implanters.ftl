...
ent-Implanter = экстрактор имплантов
    .desc =
        Шприц двойного назначения, предназначенный для удаления определённых подкожных имплантатов. После извлечения имплант хранится внутри и может быть введён повторно.
        ПРЕДУПРЕЖДЕНИЕ: Ошибка оператора, например выбор отсутствующего типа импланта, приводит к серьёзной генетической травме оператора.
