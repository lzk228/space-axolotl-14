...
ent-BorgModuleAdvancedClowning = продвинутый клоунский модуль киборга
    .desc = Продвинутый сервисный модуль только для самых смешных киборгов! В комплекте с встроенной духовкой, которая автоматически выпекает пироги со временем, проектором голокожурки и толкающим клаксоном.
