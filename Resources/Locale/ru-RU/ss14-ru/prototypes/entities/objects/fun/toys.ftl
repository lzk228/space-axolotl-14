...
ent-PlushieSpaceLizard = плюшевая космическая рептилия
    .desc = Очаровательная мягкая игрушка, напоминающая рептилию в EVA костюме. Изготовлена Центком в рамках показательной инициативы по борьбе с дискриминацией по видовому признаку в рабочей среде. "Приветствуйте своих новых коллег как вы приветствуете эту игрушку, с распростёртыми объятиями!".
...
ent-PonderingOrbWizard = шар размышлений
    .desc = Это тяжело, мужик... Очень тяжело. Волшебным образом показывает сеть камер станции.
    .suffix = Волшебник
