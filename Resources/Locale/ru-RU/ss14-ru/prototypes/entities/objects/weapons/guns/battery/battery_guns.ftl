...
ent-WeaponEnergyMagnum = энергетический магнум
    .desc = Мощный самозаряжающийся энергетический пистолет, разработанный для элитных сотрудников службы безопасности. Имеет три режима стрельбы, позволяющие наносить высокий урон, пробивать окна или нелетально обезвреживать.
