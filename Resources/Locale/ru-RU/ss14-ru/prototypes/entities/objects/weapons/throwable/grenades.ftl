...
ent-MetalFoamGrenade = металлопенная граната
    .desc = Аварийное приспособление, используемое для заделывания пробоин обшивки с помощью специальной быстрозастывающей металлической пены. Почти так же надёжно, как настоящий пол!
