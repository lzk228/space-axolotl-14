...
ent-WeaponRifleAk = АКМС
    .desc = Несколько побитая боевая винтовка, конструкция которой происходит из старой Земли. Популярна среди преступников, ополченцев и террористов благодаря своей известной надежности и простой конструкции. Питается от патронов калибра .30 винтовочный.
    .suffix = Автомат
