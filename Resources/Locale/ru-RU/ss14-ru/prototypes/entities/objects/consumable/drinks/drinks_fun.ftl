...
ent-BottomlessLube = бездонная мензурка со смазкой
    .desc = Эта аномальная мензурка бесконечно производит космическую смазу, поэтому её стоит тщательно охранять, чтобы она не попала в не те руки.
    .suffix = DEBUG
