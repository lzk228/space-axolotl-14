...
ent-PosterLegitTyrone = Путеводитель Тайрона по космосу
    .desc = Плакат, рекламирующий онлайн-школу о космосе. Перечисленные курсы, похоже, охватывают все: от базового использования оборудования станции до таких сложных предметов, как создание бомб или покрытие целых коридоров космической смазкой. Отказ от ответственности гласит: "Никогда не бывает ТАК плохо, и в конце вы даже можете получить тортилью".
