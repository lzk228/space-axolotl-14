...
ent-PosterContrabandUnreadableAnnouncement = Нечитабельное объявление
    .desc = Плакат, объявляющий о чём-то, однако, кажется, они забыли сделать его читаемым.
...
ent-PosterContrabandMoth = СиндиМоль — Ядерные операции
    .desc = Плакат, созданный по заказу Синдиката, с использованием СиндиМоль™, призывающий зрителя держать диск ядерной аутентификации незащищённым. "Мир никогда не был вариантом!" Ни один хороший сотрудник не станет прислушиваться к этой чепухе.
...
ent-PosterLegitBlessThisSpess = Боже отсек храни
    .desc = Плакат, благословляющий этот отсек.
