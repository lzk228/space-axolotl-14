...
ent-ShuttleGunKineticOld = экзоморфный дематериализатор
    .desc = Древнее корабельное орудие, использующее биомеханические системы для хранения и высвобождения энергиию. Уникальное в своём дизайне. Несмотря на уникальность конструкции, он устарел из-за низкой скорости заряжания и стрельбы по сравнению с механическими конструкциями.
