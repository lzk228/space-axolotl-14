...
ent-ClothingOuterHardsuitEVAPrisoner = тюремный скафандр ВКД
    .desc = Аварийный скафандр ВКД, предназначенный для заключённых. Он ужасно медленный и не имеет температурной защиты, но его достаточно, чтобы выиграть время в жёстком вакууме космоса.
