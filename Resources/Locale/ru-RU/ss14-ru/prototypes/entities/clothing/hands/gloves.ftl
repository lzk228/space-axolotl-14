...
ent-ClothingHandsKnuckleDusters = кастеты
    .desc = Холодные, пластальные кастеты. Увеличивают силу ваших ударов.
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Латунные кастеты, точно такие же, как раньше, и бьют так же сильно.
...
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Пластитановые кастеты с фирменной кроваво-красной буквой S. Настоящий мужчина забьёт ими кого-нибудь до смерти.
ent-ClothingHandsKnuckleDustersStun = шокер-кастеты
    .desc = Пара кастетов в сочетании с техникой шокер-дубинки. С ними бить тайдеров намного легче.
ent-ClothingHandsKnuckleBoneCrushers = кастеты-крушители
    .desc = Благословлён богами, чтобы сломать всех, кто не подчиняется.
