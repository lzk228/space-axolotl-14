...
ent-ClothingBackpackDuffelSyndicateFilledShotgun = набор "Бульдог"
    .desc = Простой и надежный: Содержит популярный дробовик Бульдог, 4 барабана пуль и 4 барабана дроби.
...
ent-ClothingBackpackDuffelSyndicateAmmoFilled = набор боеприпасов
    .desc = Перезаряжаю! Содержит 4 магазина для C-20r, 5 барабана для Бульдога и 2 короба патронов для L6 SAW.
...
ent-ClothingBackpackDuffelSyndicateFilledStarterKit = базовый набор оперативника
    .desc = Содержит одно оружие, медицинкие припасы, инструменты для взлома, запасные боеприпасы и некоторые простые инструменты.
