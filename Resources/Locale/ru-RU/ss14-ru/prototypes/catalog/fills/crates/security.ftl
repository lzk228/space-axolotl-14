...
ent-CrateSecNonlethalThrowables = ящик нелетальных метательных предметов
    .desc = Содержит по одному ящику светошумовых, травматических и слезоточивых гранат и четыре болы. Чтобы открыть, необходим уровень доступа Служба безопасности.
