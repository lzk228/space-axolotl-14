...
ui-options-function-inspect-server-component-tooltip = Открыть меню ViewVariables с серверным компонентом, установленным командой "quickinspect", сущности, над которой находится курсор.
ui-options-function-inspect-client-component = Изучить клиентский компонент
ui-options-function-inspect-client-component-tooltip = Открыть меню ViewVariables с клиентским компонентом, установленным командой "quickinspect", сущности, над которой находится курсор.
