...
book-text-ame-scribbles =
    ...
    Контроллеру ДАМ требуется высоковольтный кабель для передачи сгенерированной энергии. Если вы не уверены в наличии кабелей — подденьте пол ломом.
    Рядом с местом, где вы нашли мою записку, должна быть пустая комната. Эта комната предназначена для ДАМ. ДАМ, а не дам.
    Но вообще ДАМ можно разместить где угодно, были бы кабели.
    Расположите детали ДАМ сеткой 3x3, распакуйте их с применением мультитула. И постарайтесь не "запереть" никого внутри.
    Контроллер должен соприкасаться с ДАМ по горизонтали или вертикали (но не по диагонали).
...
book-text-combat-bakery-kit =
    ...
    Входящая в комплект плата позволит собрать микроволновую печь от Donk Co, способную выпекать ещё больше оружия.
    Как и в случае с приготовленным оружием, не забудьте съесть эту записку после прочтения. Удачи, агент.
