book-text-atmos-distro =
    ...
    Соответствующие трубы зачастую покрашены Выскакивающе-Приглушённым Синим, но безошибочный способ определить их это использовать т-лучевой сканер, чтобы отследить трубы, подключённые к активным вентиляциям станции.
