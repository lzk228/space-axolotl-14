...
loadout-name-edit-label-dataset = Задаёт пользовательское имя, которое будет использоваться, если вы играете за эту роль. Если пусто, вместо него будет выбрано случайное имя.
