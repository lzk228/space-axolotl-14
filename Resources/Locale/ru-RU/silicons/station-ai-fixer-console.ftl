...
station-ai-fixer-console-window-action-progress-repair = Ремонт в прцоессе...
...
station-ai-fixer-console-window-purge-warning-1 = Вы собираетесь навсегда удалить искуственный интелект.
station-ai-fixer-console-window-purge-warning-2 = Как только операция завершится, интелект исчезнет и не сможет быть восстановлен.
