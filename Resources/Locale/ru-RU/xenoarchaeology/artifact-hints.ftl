...
xenoarch-trigger-examine-wrenching = На нём есть частичка, которая свободно крутится вокруг.
xenoarch-trigger-examine-prying = На нём есть панель, поднявшаяся с поверхности.
xenoarch-trigger-examine-screwing = На нём есть приподнятая часть с небольшой вставкой в ней.
