...
xenoarch-trigger-examine-wrenching = На нём имеется частичка, которая свободно крутится вокруг.
xenoarch-trigger-examine-prying = На нём имеется панель, поднявшаяся с поверхности.
