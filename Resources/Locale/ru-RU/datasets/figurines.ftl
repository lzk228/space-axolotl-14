...
figurines-hop-3 = У меня перерыв.
figurines-hop-4 = Вы сможете получить полный доступ, если заполните эту форму.
...
figurines-wizard-2 = Настоящие волшебники поддерживают права трансов.
