...
changeling-devour-begin-consume-self = Жуткий рот глубоко впивается в жертву.
changeling-devour-begin-consume-others = { CAPITALIZE(POSS-ADJ($user)) } жуткий рот глубоко впивается в жертву.
changeling-devour-consume-failed-not-dead = Это тело пока живо! Нельзя его употребить!
