...
changeling-devour-begin-consume-self = Наша жуткая пасть впивается глубоко в жертву.
changeling-devour-begin-consume-others = { CAPITALIZE(POSS-ADJ($user)) } жуткая пасть впивается глубоко в жертву.
