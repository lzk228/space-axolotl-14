...
marking-VoxVisageL = Маска (Левый)
marking-VoxVisageR-visage_r = Маска (Правый)
marking-VoxVisageR = Маска (Правый)
marking-VoxCheek-cheekblush = Щёки
marking-VoxCheek = Щёки
marking-VoxBeak-beak = Клюв (Острый)
marking-VoxBeak = Клюв (Острый)
marking-VoxBeakSquareCere-beak_squarecere = Клюв (Квадратное цере)
marking-VoxBeakSquareCere = Клюв (Квадратное цере)
