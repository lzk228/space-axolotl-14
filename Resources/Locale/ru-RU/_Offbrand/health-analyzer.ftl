...
health-analyzer-plain-temperature-tooltip = The patient's body temperature.
...
health-analyzer-blood-tooltip = The patient's blood volume.
health-analyzer-damage-tooltip = The patient's total accumulated injuries.
...
-health-analyzer-brain-health-tooltip-dead = The patient has 0% brain activity and is dead.
