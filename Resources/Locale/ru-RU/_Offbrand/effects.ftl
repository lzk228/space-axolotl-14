reagent-guidebook-status-effect =
    Causes { $effect } during metabolism{ $conditionCount ->
        [0] .
...
reagent-effect-condition-guidebook-heart-damage =
    { $max ->
...
reagent-effect-condition-guidebook-lung-damage =
    { $max ->
...
reagent-effect-condition-guidebook-brain-damage =
    { $max ->
...
reagent-effect-condition-guidebook-total-group-damage =
    { $max ->
