...
tips-dataset-19 = Если Сингулярность запущена, периодически заправляйте коллекторы радиации.
...
tips-dataset-26 = Если Тесла сбежала, она будет преследовать людей, станционные машины и компьютеры. Выключив свою электронику, вы не станете менее привлекательной целью. Лучший вариант - не приближаться к ней.
...
tips-dataset-29 = Будучи призраком, вы можете использовать меню действий, чтобы автоматически следовать и крутиться вокруг любого объекта в игре.
...
tips-dataset-32 = Будучи предателем, компрометация важных каналов связи, таких как безопасности или инженерного, может дать ценные сведения. Имейте ввиду, что это происходит в обоих направлениях - служба безопасности так же может скомпрометировать коммуникацию Синдиката.
tips-dataset-33 = Будучи предателем, помните силу подозрительного ящика для инструментов. Всего за 2 телекристалла, вы можете получить полный набор инструментов, которые помогут вам в экстренной ситуации, наряду с боевыми перчатками и противогазом.
...
tips-dataset-36 = Будучи предателем, будьте осторожны, используя вестин из химического набора. Если кто-то проверит ваше рабочее место, они легко вас обнаружат.
...
tips-dataset-39 = Если вы предатель, обезвоженные карпы очень полезны для убийства группы людей. Если вы погладите его, перед тем как намочить, он может быть хорошим отвлекающим манёвром.
tips-dataset-40 = Вы пытались вводить плазму в батарейки, будучи предателем? В случае дефибриллятора, он взорвётся при использовании, ранив и пользователя и пациента.
...
tips-dataset-44 = Будучи предателем, помните о силе разрушения телекоммуникаций. Людям будет гораздо сложнее поймать вас, если они не смогут общаться с другими на больших расстояниях!
...
tips-dataset-50 = As a Salvage Specialist, try asking science for a grappling hook. It can be used to propel yourself onto wrecks, or if stuck in space you don't have to rely on the proto-kinetic accelerator. Будучи утилизатором, попробуйте попросить учёных о крюке-пушке. С его помощью можно цепляться к обломкам, а если вы застряли в космосе, вам не придётся полагаться на протокинетический ускоритель.
tips-dataset-51 = Совет #51 не существует и никогда не существовал. Игнорируйте любые слухи об обратном.
tips-dataset-52 = Будучи утилизатором, сотрудничайте с грузчиками. Они могут заказать вам самые разные полезные предметы, в том числе те, которые будет трудно получить другим способом, такие как лазерные пушки и строительные материалы для шаттлов.
...
tips-dataset-55 = Будучи грузчиком, если у вас есть деньги, попробуйте азарт! Иногда вы получаете больше денег, чем в начале.
...
tips-dataset-57 = Будучи барменом помните, что вы можете использовать циркулярной пилой на своем ружье, чтобы его стало легче хранить.
...
tips-dataset-65 = Будучи адвокатом, попытайтесь договориться со Смотрителем, если наказание кажется слишком тяжёлым.
...
tips-dataset-73 = Будучи инженером, дважды проверяйте Сингулярность во время запуска. Потерять её проще, чем вы думаете.
tips-dataset-74 = Будучи инженером, вы можете использовать плазменное стекло, чтобы укрепить территорию и предотвратить радиацию.
...
tips-dataset-80 = Будучи учёным, вы можете использовать улучшенные версии машин, чтобы улучшить их эффективность. Это может сделать некоторые машины значительно лушче, утилизаторы полюбят вас, если вы улучшите переработчик руды.
tips-dataset-81 = Будучи учёным, вы можете строить киборгов, используя позитронные мозги и шасси. Они такие же полезны как и новые члены экипажа.
...
tips-dataset-84 = Будучи врачом, будьте осторожны при помещении рептилий в криокапсулы. Они получат много дополнительного урона от холода, но вы всегда сможете смягчить это с помощью мази или лепоразина.
...
tips-dataset-86 = Будучи химиком, как только вы сделали все, что вам нужно, не бойтесь делать больше глупых реагентов. Вы пробовали дезоксиэфедрин или ликоксид?
...
tips-dataset-93 = Все мы когда-то были новичками. Будьте терпеливы и подсказывайте новым игрокам, особенно тем, кто играет на ролях стажёров, направляя их в правильное русло.
tips-dataset-94 = Пожарные костюмы, зимние куртки и ВКД скафандры обеспечивают умеренную защиту от холода, позволяя вам проводить в космосе и в разгерметизированных отсеках больше времени, чем если бы на вас не было ничего.
...
tips-dataset-102 = Вы можете наполнить ранцевый резервуар напалмом для создания огнемёта.
tips-dataset-103 = Большинство работ имеют альтернативную униформу в шкаф-автоматах. Не бойтесь опробовать новый стиль!
tips-dataset-104 = Скорость - это почти всё в бою. Использование скафандров из-за их защиты - обычно плохая идея, если только защита, которую он даёт, не предназначена для боя или вы не планируете лезть в гущу сражений.
...
tips-dataset-108 = Вы можете пшикать огнетушителем, бросать вещи или стрелять из оружия, когда летаете в космосе, чтобы получить незначительное ускорение. Просто стреляйте в противоположную сторону от той, куда вам нужно попасть.
...
tips-dataset-118 = You can use sharp objects to butcher clothes or animals in the right click context menu. This includes glass shards. Вы можете использовать острые объекты, чтобы разрезать одежду или разделать животное в контекстном меню при нажатии ПКМ. В том числе осколки стекла.
...
tips-dataset-136 = Если вы застряли за наэлектрифицированной дверью, отключите ЛКП или бросьте вашу ID в дверь, чтобы не получить удар током.
tips-dataset-137 = If the AI electrifies a door and you have insulated gloves, snip and mend the power wire to reset their electrification! Если ИИ наэлектрифицировал дверь и у вас есть изолирующие перчатки, перережьте и почините кабель питания, чтобы сбросить электрификацию.
