...
tips-dataset-118 = Вы можете использовать острые объекты, чтобы разрезать одежду или разделать животное в контекстном меню при нажатии ПКМ. В том числе осколки стекла.
...
tips-dataset-137 = Если ИИ наэлектрифицировал дверь и у вас есть изолирующие перчатки, перережьте и почините кабель питания, чтобы сбросить электрификацию.
