...
job-board-radio-announce = Утилизаторский ранг повышен до [bold]{ $rank }[/bold]! Новые товары можно купить в отделе снабжения.
...
bounty-description-salvage-ore-gold = Мы занимаемся экспериментальным новым процессом производства электроники. Доставьте нам большую партию необработанной золотой руды. Она может быть любого происхождения.
...
bounty-description-tooth-sharkminnow = Нам нужно, чтобы вы достали образец зуба карпоакулы. Эти ребята гораздо опаснее, чем мелкие карпы, с которыми вы привыкли иметь дело. Будьте осторожны, чтобы они вас не укусили, они лечатся за счёт питья вашей крови.
bounty-description-salvage-ore-plasma = Нам нужна партия плазменной руды для отправки на исследовательскую станцию. Пожалуйста, предоставьте нам ее, чтобы мы могли продолжить наши испытания. Она может быть любого происхождения.
...
bounty-description-salvage-ore-bananium = Мы ведем проект по расшифровке загадочной геномной последовательности клоуна. Мы полагаем, что образец сырого бананиума поможет нам в этом. Обратите внимание, что он добывается только из самых редких астероидов в глубоком космосе.
bounty-description-remains = Нам нужно, чтобы вы дотали несколько образцов ядер повелителя улья. Имейте в виду, что повелители улья могут бесконечно размножаться, если ядро не будет уничтожено. Будьте осторожны, чтобы не ошеломиться.
