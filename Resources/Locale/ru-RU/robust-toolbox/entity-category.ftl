...
entity-category-desc-spawner = Протипы сущностей, спавнящие других сущностей.

entity-category-name-hide = Скрытые
entity-category-desc-hide = Протипы сущностей, которые должны быть скрыты в панели спавна сущностей

entity-category-name-fork = Отфильтрованы форком
