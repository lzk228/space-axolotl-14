...
spellbook-smite-desc = Не любите кого-то? РАЗОРВИТЕ его на потроха! Требует шляпу и робу волшебника.
spellbook-cluwne-name = Проклятие клувня
spellbook-cluwne-desc = Для случаев, когда вы действительно кого-то ненавидите и кары недосаточно. Требует шляпу и робу волшебника.
spellbook-slip-name = Скользкая дорожка
spellbook-slip-desc = Изучите древние приёмы уборщиков и прокляните вашу цель, чтобы та была скользкой. Требует шляпу и робу волшебника.
