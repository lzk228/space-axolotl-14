...
spellbook-repulse-desc = Прикажите людям уходить и оттолкните их от себя.
spellbook-smoke-name = Дым
spellbook-smoke-desc = Создаёт облако дыма, это вполне очевидно.
...
spellbook-hammer-singularity-description = Вы когда-нибудь задумывались, каково это - быть сингулярностью? Размахивайте этим молотом, чтобы нарисовать свое окружение, даже если вы промахнетесь!
