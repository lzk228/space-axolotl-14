...
uplink-energycrossbow-desc = Незаменимый пистолет любого оперативника, который предпочитает, чтобы его жертвы не двигались. Стреляет возобновляющимися ядовитыми болтами, которые мгновенно сбивают жертву с ног.
