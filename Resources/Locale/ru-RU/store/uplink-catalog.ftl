...
uplink-whitehole-grenade-desc = Граната, которая отталкивает всё вокруг в течение примерно 10 секунд. Очень полезна в небольших помещениях и при преследовании.
...
uplink-speedloader-magnu-desc = Спидлоадер с 6 бронебойными патронами для револьвера, полностью игнорирующими броню. Совместим с "Питоном".
...
uplink-reinforcement-radio-ancestor-desc = Призовите на помощь специально обученного предка на ваш выбор. Комплектуется одной сигаретой Синдиката.
...
uplink-eshield-desc = Экзотический энергощит, отражающий почти все лазерные лучи, а также дающий небольшую защиту от пуль и других физических атак.
...
uplink-briefcase-gun-name = Оружие-чемодан
...
uplink-energycrossbow-name = маленький энергоарбалет
uplink-energycrossbow-desc = Незаменимый пистолет любого оперативника, который предпочитает, чтобы его жертвы не двигались. Стреляет возобновляющимися ядовитыми зарядами, которые мгновенно сбивают жертву с ног.
