...
uplink-penguin-grenade-desc = Маленький, крайне агрессивный пингвин с гранатой на шее. Натренирован игнорировать всех агентов Синдиката и неустанно преследовать ближайшую, случайную цель, как только его выпустят.
uplink-c4-name = C-4
...
uplink-syndicate-id-card-desc = ID-карта Синдиката, с доступом Синдиката. Сама по себе вряд ли будет полезна, но отлично сочетается с перенастроенными дверями. Не имеет функции копирования доступа.
