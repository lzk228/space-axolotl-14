cmd-quickinspect-desc = Установить имя компонента, который откроется, если навести курсор на игрока и нажать клавишу "Изучить серверный/клиентский компонент".
