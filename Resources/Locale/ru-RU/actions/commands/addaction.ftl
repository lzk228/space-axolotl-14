# addaction
cmd-addaction-desc = Добавляет действие целевой сущности. Добавленое действие не будет работать, если сущность должна иметь дополнительные компоненты (к примеру поглощение дракона).
...
cmd-addaction-action-not-found = Не удалось найди прототип действия { $action }.
