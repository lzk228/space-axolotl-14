...
admin-solutions-window-solution-button-tooltip = Открывает соответсвующий раствор на серверной стороне в меню ViewVariables. Полезно, для дебага проблем с предсказыванием.
admin-solutions-window-vv-button = VV
admin-solutions-window-vv-button-tooltip = Открывает соответсвующий раствор в меню ViewVariables.
